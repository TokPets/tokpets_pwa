...
<form v-on:submit.prevent="onSubmitSignIn">
    ...
    <input type="email" placeholder="Ingresa tu Email" v-model="USER.email" required aria-required="true">
    </div>
    <div class="input-group password">
    <img class="password" src="@/assets/icons/lock.png" alt="Password Icon" >
    <input type="password" placeholder="Ingresa tu Password" v-model="USER.password" required aria-required="true">
    </div>
