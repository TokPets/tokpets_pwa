      ...
      <div class="section-content">
        <div class="wrapper">
          ...
          <div class="pet-inputs">
            <div class="pet-input pet-name"></div>
            <div class="pet-input pet-gender"></div>
            <div class="pet-input pet-birthday"></div>
            <div class="pet-input pet-breed"></div>
            <div class="pet-input pet-country"></div>
            <div class="pet-input pet-city"></div>
          </div>
        </div>
      </div>
